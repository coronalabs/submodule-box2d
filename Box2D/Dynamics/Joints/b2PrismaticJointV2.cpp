...
void b2PrismaticJointDefV2::Initialize(b2Body* bA, b2Body* bB, const b2Vec2& anchor, const b2Vec2& axis)
{
	bodyA = bA;
	bodyB = bB;
...
b2PrismaticJointV2::b2PrismaticJointV2(const b2PrismaticJointDefV2* def)
: b2Joint(def)
{
...
void b2PrismaticJointV2::InitVelocityConstraints(const b2SolverData& data)
{
...
void b2PrismaticJointV2::SolveVelocityConstraints(const b2SolverData& data)
{
	b2Vec2 vA = data.velocities[m_indexA].v;
	float wA = data.velocities[m_indexA].w;
	b2Vec2 vB = data.velocities[m_indexB].v;
...
bool b2PrismaticJointV2::SolvePositionConstraints(const b2SolverData& data)
{
	b2Vec2 cA = data.positions[m_indexA].c;
	float aA = data.positions[m_indexA].a;
	b2Vec2 cB = data.positions[m_indexB].c;
...
b2Vec2 b2PrismaticJointV2::GetAnchorA() const
{
	return m_bodyA->GetWorldPoint(m_localAnchorA);
}

b2Vec2 b2PrismaticJointV2::GetAnchorB() const
{
	return m_bodyB->GetWorldPoint(m_localAnchorB);
}

b2Vec2 b2PrismaticJointV2::GetReactionForce(float inv_dt) const
{
	return inv_dt * (m_impulse.x * m_perp + (m_motorImpulse + m_lowerImpulse + m_upperImpulse) * m_axis);
}

float b2PrismaticJointV2::GetReactionTorque(float inv_dt) const
{
	return inv_dt * m_impulse.y;
}

float b2PrismaticJointV2::GetJointTranslation() const
{
...
float b2PrismaticJointV2::GetJointSpeed() const
{
	b2Body* bA = m_bodyA;
	b2Body* bB = m_bodyB;
...
bool b2PrismaticJointV2::IsLimitEnabled() const
{
	return m_enableLimit;
}

void b2PrismaticJointV2::EnableLimit(bool flag)
{
...
float b2PrismaticJointV2::GetLowerLimit() const
{
	return m_lowerTranslation;
}

float b2PrismaticJointV2::GetUpperLimit() const
{
	return m_upperTranslation;
}

void b2PrismaticJointV2::SetLimits(float lower, float upper)
{
...
bool b2PrismaticJointV2::IsMotorEnabled() const
{
	return m_enableMotor;
}

void b2PrismaticJointV2::EnableMotor(bool flag)
{
...
void b2PrismaticJointV2::SetMotorSpeed(float speed)
{
...
void b2PrismaticJointV2::SetMaxMotorForce(float force)
{
...
float b2PrismaticJointV2::GetMotorForce(float inv_dt) const
{
	return inv_dt * m_motorImpulse;
}

void b2PrismaticJointV2::Dump()
{
	// FLT_DECIMAL_DIG == 9
	...
	b2Log("  b2PrismaticJointDefV2 jd;\n");
